                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$item->name}}</td>
                            <td>{{$item->email}}</td>
                            <td><button class="btn btn-sm btn-success" data-toggle="modal" data-target="#exampleModal{{$item->id}}">Edit</button> <a href="{{url('dosen/'. $item->id)}}" class="btn btn-sm btn-danger">Hapus</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
